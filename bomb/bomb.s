...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # must equal (4 bytes)
  400f0e:	74 20                	je     400f30 <phase_2+0x34> # 0x400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax # (%rbx-0x4)
  400f1a:	01 c0                	add    %eax,%eax # (%rbx-0x4)*2
  400f1c:	39 03                	cmp    %eax,(%rbx) # must equal (4 bytes)
  400f1e:	74 05                	je     400f25 <phase_2+0x29> # 0x400f25
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx # %rbx+0x4
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> # 0x400f17
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> # 0x400f3c
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx # %rsp+0x4
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp # %rsp+0x18
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b> # 0x400f17
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # y
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # x
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi # "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax # must greater (int)
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> # 0x400f6a
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # must not above (unsigned)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # 0x400fad
  ...
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b> # 0x400fbe
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax # x=1
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax # must equal (4 bytes)
  400fc2:	74 05                	je     400fc9 <phase_3+0x86> # 0x400fc9
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>: # x in %edi, l in %esi, r in %edx
  ...
  400fdd:	d1 f8                	sar    %eax       # (r - l) / 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # mid = l + (r - l) / 2
  400fe2:	39 f9                	cmp    %edi,%ecx  # mid <= x (int)
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # L1

  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx  # r = mid - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax  # return func4(x, l, r) * 2;
  400ff0:	eb 15                	jmp    401007 <func4+0x39> # L2
  
  # L1:
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax  # 0
  400ff7:	39 f9                	cmp    %edi,%ecx  # if (mid == x) return 0;
  400ff9:	7d 0c                	jge    401007 <func4+0x39>

  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi # l = mid + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax # return func4(x, l, r) * 2 + 1;
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax # must equal (4 bytes)
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # must blow or equal (unsigned)
  ...
  40104d:	85 c0                	test   %eax,%eax # must equal (4 bytes)
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) # must equal (4 bytes)
...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax # must equal (4 bytes)
  401082:	74 4e                	je     4010d2 <phase_5+0x70> # L1

  ; 401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  ; 401089:	eb 47                	jmp    4010d2 <phase_5+0x70> # L1
  ...
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax # not equal (8 bytes)
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> # L2

  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi # "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax # must equal (4 bytes)
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> # L3
  
  ; 4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  ; 4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  ; 4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77> # L3

  # L1
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29> # 0x40108b L2

  # L3
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c> # 0x4010ee
...
00000000004010f4 <phase_6>:
  ...
  # L2
  401114:	4c 89 ed             	mov    %r13,%rbp # a+i
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # a[i]
  40111b:	83 e8 01             	sub    $0x1,%eax # a[i]-1
  40111e:	83 f8 05             	cmp    $0x5,%eax # a[i] <= 6 (unsigned)
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d # i++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d # i<6
  401130:	74 21                	je     401153 <phase_6+0x5f> # L3 (only way to leave L2)

  401132:	44 89 e3             	mov    %r12d,%ebx # j=i

  # L1 in
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # a[j]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # a[i-1] != a[j] (4 bytes)
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx # j++
  401148:	83 fb 05             	cmp    $0x5,%ebx # j<=5
  40114b:	7e e8                	jle    401135 <phase_6+0x41> # L1

  40114d:	49 83 c5 04          	add    $0x4,%r13 # a+i
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # L2

  # 总结：a[i] <= 6，互不相等

  # L3
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi # a+6
  ...
  40116a:	48 39 f0             	cmp    %rsi,%rax # i<=6
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # L4

  # 总结：a[i] = 7-a[i]

  40116f:	be 00 00 00 00       	mov    $0x0,%esi # i=0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> # L5

  # L6 in
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx # p=p->next
  40117a:	83 c0 01             	add    $0x1,%eax # j++
  40117d:	39 c8                	cmp    %ecx,%eax # j<a[i]
  40117f:	75 f5                	jne    401176 <phase_6+0x82> # L6

  401181:	eb 05                	jmp    401188 <phase_6+0x94> # L8

  # L7
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx # 0x6032d0

  # L8
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # b[i]=p
  40118d:	48 83 c6 04          	add    $0x4,%rsi # i++
  401191:	48 83 fe 18          	cmp    $0x18,%rsi # i<6
  401195:	74 14                	je     4011ab <phase_6+0xb7> # L9 (only way to leave L6)

  # L5
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx # a[i]
  40119a:	83 f9 01             	cmp    $0x1,%ecx # a[i]<=1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # L7

  40119f:	b8 01 00 00 00       	mov    $0x1,%eax # j=1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx # p=head
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> # L6

  # 总结：p[i] = node[a[i]]

  # L9
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # b[0]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # b+1 / i=1
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi # b+6
  4011ba:	48 89 d9             	mov    %rbx,%rcx # b[0]

  # L10 in
  4011bd:	48 8b 10             	mov    (%rax),%rdx # b[1]
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) # b[0]->next=b[1]
  4011c4:	48 83 c0 08          	add    $0x8,%rax # i++
  4011c8:	48 39 f0             	cmp    %rsi,%rax # i<7
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>  # L11 (only way to leave L10)

  4011cd:	48 89 d1             	mov    %rdx,%rcx # b[1]
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> # L10

  # 总结：p[i]->next = p[i+1]

  # L11
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) # p[5]->next=0
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp # i=5

  # 12 in
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax # p[0]->next / p[1]
  4011e3:	8b 00                	mov    (%rax),%eax # p[1]->data
  4011e5:	39 03                	cmp    %eax,(%rbx) # p[0]->data >= p[1]->data (int)
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx # p[0]->next
  4011f2:	83 ed 01             	sub    $0x1,%ebp # i--;i>0
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> # 12

  # 总结：p[i]->data >= p[i+1]->data
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi # if (p == 0) return 0xffffffff;
  40120b:	74 2b                	je     401238 <fun7+0x34>
  40120d:	8b 17                	mov    (%rdi),%edx # p->data
  40120f:	39 f2                	cmp    %esi,%edx # p->data <= l
  401211:	7e 0d                	jle    401220 <fun7+0x1c> # L1

  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi # p = p->left
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax # return fun7(p,l) * 2;
  40121e:	eb 1d                	jmp    40123d <fun7+0x39> # L2

  # L1
  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx # if (p->data == l) return 0;
  401227:	74 14                	je     40123d <fun7+0x39> # L2

  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi # p = p->right
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax # return fun7(p,l) * 2 + 1;
  401236:	eb 05                	jmp    40123d <fun7+0x39> # L2
...
0000000000401242 <secret_phase>:
  ...
  401252:	48 89 c7             	mov    %rax,%rdi # 输入字符串
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>
  40125a:	48 89 c3             	mov    %rax,%rbx # l
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax # (l-1) low 4 bytes
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax # l <= 1000
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi # l low 4 bytes
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax # = 2
...
000000000040145c <read_six_numbers>:
  ...
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d> # 0x401499
...
00000000004015c4 <phase_defused>:
  ...
  4015e6:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # %d
  4015eb:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # %d
  4015f0:	be 19 26 40 00       	mov    $0x402619,%esi # "%d %d %s"
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi # <phase_4>的输入
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax # 3
  401602:	75 31                	jne    401635 <phase_defused+0x71>
  401604:	be 22 26 40 00       	mov    $0x402622,%esi # "DrEvil"
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi # %s
  40160e:	e8 25 fd ff ff       	callq  401338 <strings_not_equal>
  401613:	85 c0                	test   %eax,%eax # 0
